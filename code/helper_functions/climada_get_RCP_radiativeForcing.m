...
% rcp_file: user defined path of RCP file (XLS), default = .../climada_modules/country_risk/data/rcp_db.xls
%
% OUTPUT:
...
if isempty(rcp_file),rcp_file=[climada_global.modules_dir filesep 'country_risk' filesep 'data' filesep 'rcp_db.xls'];end
%%
