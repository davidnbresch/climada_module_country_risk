function entity=climada_nightlight_global_entity(parameters)
...
if isempty(parameters.resolution_km),parameters.resolution_km=10;end
...
low_img_filename=[module_data_dir filesep 'night_light_2010_10km.mat'];
%
